...
export default {
  ...
  support: "Podpora",
  discord: "Discord",
  powered_by_kardon_pages: "Poháněno Kardon Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Většina věcí začíná projektem v Kardon.",
        cta: "Začít",
      },
      invite_team: {
        title: "Pozvat tým",
  ...
  workspace_creation: {
    ...
    subheading: "Pro používání Kardon musíte vytvořit nebo se připojit k pracovnímu prostoru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Vítejte v Kardon, jsme rádi, že jste zde. Vytvořte první projekt, sledujte pracovní položky a tato stránka se promění v prostor pro váš pokrok. Správci zde uvidí i položky pomáhající týmu.",
        primary_button: {
          text: "Vytvořte první projekt",
          comic: {
            title: "Vše začíná projektem v Kardon",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Zkopírujte a uložte tento klíč do Kardon Pages. Po zavření jej neuvidíte. CSV soubor s klíčem byl stažen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Používejte API pro integraci Kardon s externími systémy.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Kardon bude automaticky archivovat pracovní položky, které byly dokončeny nebo zrušeny.",
        duration: "Automaticky archivovat pracovní položky, které jsou uzavřené po dobu",
      },
      "auto-close": {
        title: "Automaticky uzavírat pracovní položky",
        description: "Kardon automaticky uzavře pracovní položky, které nebyly dokončeny nebo zrušeny.",
  ...
  self_hosted_maintenance_message: {
    kardon_didnt_start_up_this_could_be_because_one_or_more_kardon_services_failed_to_start:
      "Kardon se nespustil. To může být způsobeno tím, že se jeden nebo více služeb Kardon nepodařilo spustit.",
