...
This package is part of the Kardon workspace and can be used by adding it to your project's dependencies:

```json
{
  "dependencies": {
    "@kardon/decorators": "workspace:*"
  }
}
```
...
```typescript
import { Controller, Get, Post, BaseController } from "@kardon/decorators";
...
```typescript
import { Controller, WebSocket, BaseWebSocketController } from "@kardon/decorators";
...
This project is licensed under the [GNU Affero General Public License v3.0](https://github.com/makekardon/kardon/blob/master/LICENSE.txt).
