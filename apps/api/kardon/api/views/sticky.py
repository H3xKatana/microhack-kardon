...
from kardon.db.models import Sticky, Workspace
from kardon.api.serializers import StickySerializer

# OpenAPI imports
from kardon.utils.openapi.decorators import sticky_docs
