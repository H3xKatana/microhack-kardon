...
# Module imports
from kardon.utils.url import is_valid_url
...
MIDDLEWARE = [
    ...
    "kardon.authentication.middleware.session.SessionMiddleware",
    ...
    "kardon.middleware.request_body_size.RequestBodySizeLimitMiddleware",
    "kardon.middleware.logger.APITokenLogMiddleware",
    "kardon.middleware.logger.RequestLoggerMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "kardon.authentication.adapter.exception.auth_exception_handler",
...
WSGI_APPLICATION = "kardon.wsgi.application"
ASGI_APPLICATION = "kardon.asgi.application"
...
if os.environ.get("ENABLE_READ_REPLICA", "0") == "1":
    ...
    # Database Routers
    DATABASE_ROUTERS = ["kardon.utils.core.dbrouters.ReadReplicaRouter"]
    # Add middleware at the end for read replica routing
    MIDDLEWARE.append("kardon.middleware.db_routing.ReadReplicaRoutingMiddleware")
...
STORAGES["default"] = {"BACKEND": "kardon.settings.storage.S3Storage"}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "kardon.bgtasks.issue_automation_task",
    "kardon.bgtasks.exporter_expired_task",
    "kardon.bgtasks.file_asset_task",
    "kardon.bgtasks.email_notification_task",
    "kardon.bgtasks.cleanup_task",
    "kardon.license.bgtasks.tracer",
    # management tasks
    "kardon.bgtasks.dummy_data_task",
    # issue version tasks
    "kardon.bgtasks.issue_version_sync",
    "kardon.bgtasks.issue_description_version_sync",
)
...
SESSION_ENGINE = "kardon.db.models.session"
...
CSRF_FAILURE_VIEW = "kardon.authentication.views.common.csrf_failure"
