...
SPECTACULAR_SETTINGS = {
    ...
    "LICENSE": {
        "name": "GNU AGPLv3",
        "url": "https://github.com/makekardon/kardon/blob/preview/LICENSE.txt",
    },
    # ========================================================================
    ...
    # ========================================================================
    "PREPROCESSING_HOOKS": [
        "kardon.utils.openapi.hooks.preprocess_filter_api_v1_paths",
    ],
    # ========================================================================
    ...
    "SERVERS": [
        ...
        {"url": "https://api.kardon.so", "description": "Production"},
    ],
    # ========================================================================
    # API Tag Definitions
    # ========================================================================
    ...
    "AUTHENTICATION_WHITELIST": [
        "kardon.api.middleware.api_authentication.APIKeyAuthentication",
    ],
    # ========================================================================
    ...
    "ENUM_NAME_OVERRIDES": {
        "ModuleStatusEnum": "kardon.db.models.module.ModuleStatus",
        "IntakeWorkItemStatusEnum": "kardon.db.models.intake.IntakeIssueStatus",
    },
}
