...
# Module imports
from kardon.license.models import Instance, InstanceEdition
from kardon.license.bgtasks.tracer import instance_traces
    ...
    def check_for_latest_version(self, fallback_version):
        try:
            response = requests.get(
                "https://api.github.com/repos/makekardon/kardon/releases/latest",
                timeout=10,
            )
    ...
    def handle(self, *args, **options):
        ...
        if instance is None:
            ...
            instance = Instance.objects.create(
                instance_name="Kardon Community Edition",
