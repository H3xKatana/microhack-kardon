...
```python
from kardon.utils.openapi import (
    asset_docs,
    ASSET_ID_PARAMETER,
...
```python
from kardon.utils.openapi.decorators import asset_docs
from kardon.utils.openapi.parameters import ASSET_ID_PARAMETER
from kardon.utils.openapi.responses import UNAUTHORIZED_RESPONSE
```
...
- `kardon/api/views/asset.py` - All methods use new `@asset_docs` helpers
- `kardon/api/views/project.py` - Import updated
- `kardon/api/views/user.py` - Import updated
- `kardon/api/views/state.py` - Import updated
- `kardon/api/views/intake.py` - Import updated
- `kardon/api/views/member.py` - Import updated
- `kardon/api/views/module.py` - Import updated
- `kardon/api/views/cycle.py` - Import updated
- `kardon/api/views/issue.py` - Import updated
- `kardon/settings/common.py` - Hook paths updated
- `kardon/api/apps.py` - Auth extension import updated
