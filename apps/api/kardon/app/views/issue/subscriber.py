...
from kardon.app.serializers import IssueSubscriberSerializer, ProjectMemberLiteSerializer
from kardon.app.permissions import ProjectEntityPermission, ProjectLitePermission
from kardon.db.models import IssueSubscriber, ProjectMember
