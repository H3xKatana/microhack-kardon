...
from kardon.app.serializers import LabelSerializer
from kardon.app.permissions import allow_permission, ProjectBasePermission, ROLE
from kardon.db.models import Project, Label
