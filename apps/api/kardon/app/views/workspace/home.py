...
from kardon.db.models.workspace import WorkspaceHomePreference
from kardon.app.permissions import allow_permission, ROLE
from kardon.db.models import Workspace
from kardon.app.serializers.workspace import WorkspaceHomePreferenceSerializer
...
class WorkspaceHomePreferenceViewSet(BaseAPIView):
    ...
    def get(self, request, slug):
        ...
        keys = [
            ...
            if key not in ["quick_tutorial", "new_at_kardon"]
        ]
