...
from kardon.db.models import Webhook, WebhookLog
from kardon.db.models.webhook import validate_domain, validate_schema
...
class WebhookSerializer(DynamicBaseSerializer):
    ...
    def create(self, validated_data):
        ...
        disallowed_domains = ["kardon.so"]  # Add your disallowed domains here
        if request:
