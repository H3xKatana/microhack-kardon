...
import type { EditorRefApi, CollaborationState } from "@kardon/editor";
// kardon editor
import { convertBinaryDataToBase64String, getBinaryDataFromDocumentEditorHTMLString } from "@kardon/editor";
// kardon types
