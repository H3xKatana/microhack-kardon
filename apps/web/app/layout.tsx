...
export const meta = () => [
  { title: "Kardon | Simple, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "Kardon | Simple, extensible, open-source project management tool." },
  {
    property: "og:description",
    content: "Open-source project management tool to manage work items, cycles, and product roadmaps easily",
  },
  { property: "og:url", content: "https://kardon.hawiyat.org/" },
  { property: "og:image", content: "https://kardon.hawiyat.org/app/assets/logo.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Kardon - Collaboration & Workflow Platform" },
  { name: "twitter:site", content: "@kardon" },
  { name: "twitter:card", content: "kardon" },
  { name: "twitter:image", content: "https://kardon.hawiyat.org/app/assets/logo.png" },
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Kardon" />
