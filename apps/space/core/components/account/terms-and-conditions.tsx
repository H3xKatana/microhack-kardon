  ...
  return (
    <span className="flex items-center justify-center py-6">
      <p className="text-center text-13 text-secondary whitespace-pre-line">
        ...
        <Link href="https://www.hawiyat.org/terms" target="_blank" rel="noopener noreferrer">
          <span className="text-13 font-medium underline hover:cursor-pointer">Terms of Service</span>
        </Link>{" "}
        and{" "}
        <Link href="https://www.hawiyat.org/privacy" target="_blank" rel="noopener noreferrer">
