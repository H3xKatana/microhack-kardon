...
import type { IFormattedInstanceConfiguration, TInstanceEmailConfigurationKeys } from "@kardon/types";
// ui
...
export function InstanceEmailForm(props: IInstanceEmailForm) {
  ...
  const emailFormFields: TControllerInputFormField[] = [
    ...
    },
    {
      ...
      placeholder: "no-reply@projectkardon.so",
  ...
  const OptionalEmailFormFields: TControllerInputFormField[] = [
    {
      ...
      type: "text",
      label: "Username",
      placeholder: "getitdone@projectkardon.so",
